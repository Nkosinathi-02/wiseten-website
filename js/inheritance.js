        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    ...
                    <p> We as Wiseten Company we pride ourselves with our service in Welding and industrial equipment since it’s establishment, serving industries across South Africa with reliable solutions and exceptional service.</p>
                </div>
                <div class="footer-section">
                    <h3><i class="fas fa-address-book"></i> Contact Info</h3>
                    <p><i class="fas fa-phone"></i> <a href="tel:0840262830">0840262830/ 0615493309</a></p>
                    <p><i class="fas fa-envelope"></i> <a href="mailto:admin@wisetenengeneering.co.za">admin@wisetenengeneering.co.za</a></p>
                    
                    <p><i class="fas fa-map-marker-alt"></i> Address: 85 Goodwood Road West Mead, Pinetown 3609</p>
                    <p><i class="fas fa-map-marker-alt"></i> Richards Bay - Ceramic Curve 20, KwaZulu Natal 3900</p>
                </div>
                <div class="footer-section">
